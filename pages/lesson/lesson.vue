<template>
	<view class="my_lesson_content">
		<view class="class_meun">
			<text v-if="isShow" :class="lessonType == -1 ? 'active' : ''" @click="getLessonList('-1')">{{ $t('index').allCourses }}</text>
			<text v-if="isShow" :class="lessonType == 0 ? 'active' : ''" @click="getLessonList('0')">{{ $t('index').ToBePaid }}</text>
			<text :class="lessonType == 1 ? 'active' : ''" @click="getLessonList('1')">{{ $t('index').waitingForClass }}</text>
			<text :class="lessonType == 3 ? 'active' : ''" @click="getLessonList('3')">{{ $t('index').completed }}</text>
		</view>
