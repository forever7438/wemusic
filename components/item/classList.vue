		...
		<ul>
			<li v-for="(item, index) in 6" :key="index">
				...
				<div class="class_operation">
					...
					<span>
						<navigator hover-class="none" url="/pages/addTask/addTask?classId=1">作业</navigator>
					</span>
				</div>
				<navigator hover-class="none" url="/pages/classAdjustment/classAdjustment?classId=1">
