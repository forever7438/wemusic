<template>
	<ul class="time_list">
		<li v-for="(item, index) in dateList" @click="flag && selctitem(index)" :class="{ active: item.id == timeChecked }"
		 :key="index">
			<p>
		...
		<mpvue-picker themeColor="#007AFF" ref="mpvuePicker" mode="selector" titleInfo="选择时长" :deepLength="1"
