...
Z([1,true])
Z([3,'__e'])
Z([[4],[[5],[[4],[[5],[[5],[1,'^refreshData']],[[4],[[5],[[4],[[5],[1,'getFriendList']]]]]]]]])
...
var o6=_mz(z,'friend-operation',['bind:refreshData',11,'data-event-opts',1,'forward',2,'is_forward',3,'is_praise',4,'listId',5,'message',6,'praise',7],[],aZ,lY,gg)
cs.pop()
_(b3,o6)
cs.pop()
_(t1,b3)
...
var cVF=_n('friends-list')
_rz(z,cVF,'friendsList',4,e,s,gg)
cs.pop()
_(oTF,cVF)
cs.pop()
_(r,oTF)
...
var b3H=_n('friends-list')
_rz(z,b3H,'friendsList',2,e,s,gg)
cs.pop()
_(e2H,b3H)
cs.pop()
_(r,e2H)
...
"use strict";(global["webpackJsonp"] = global["webpackJsonp"] || []).push([["components/friendsAssembly/friendOperation"], { "04dd": function dd(t, e, n) {"use strict";var a = n("d028"),s = n.n(a);s.a;}, "3bba": function bba(t, e, n) {"use strict";n.r(e);var a = n("5700"),s = n.n(a);for (var i in a) {"default" !== i && function (t) {n.d(e, t, function () {return a[t];});}(i);}e["default"] = s.a;}, 5700: function _(t, e, n) {"use strict";(function (t) {Object.defineProperty(e, "__esModule", { value: !0 }), e.default = void 0;var n = { props: { message: Number, praise: Number, forward: Number, listId: String, is_forward: Number, is_praise: Number }, methods: { liked: function liked(e) {var n = this;this.ajax({ url: "friend/praise", data: { friend_id: this.listId }, success: function success(e) {"success" === e.data.body ? (n.$emit("refreshData"), t.showToast({ title: "点赞成功", icon: "none" })) : t.showToast({ title: e.data.msg, icon: "none" });} });}, share: function share(e) {var n = this;e || this.ajax({ url: "friend/forward", data: { friend_id: this.listId }, success: function success(e) {"success" === e.data.body ? (n.is_forward = 1, n.$emit("refreshData"), t.showToast({ title: "转发成功", icon: "none" })) : t.showToast({ title: e.data.msg, icon: "none" });} });} } };e.default = n;}).call(this, n("6e42")["default"]);}, 9482: function _(t, e, n) {"use strict";n.r(e);var a = n("ed8e"),s = n("3bba");for (var i in s) {"default" !== i && function (t) {n.d(e, t, function () {return s[t];});}(i);}n("04dd");var r = n("2877"),o = Object(r["a"])(s["default"], a["a"], a["b"], !1, null, null, null);e["default"] = o.exports;}, d028: function d028(t, e, n) {}, ed8e: function ed8e(t, e, n) {"use strict";var a = function a() {var t = this,e = t.$createElement;t._self._c;},s = [];n.d(e, "a", function () {return a;}), n.d(e, "b", function () {return s;});} }]);
;(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/circleFriends/circleFriends"],{"23ea":function(n,t,e){"use strict";e.r(t);var i=e("f2f9"),a=e.n(i);for(var o in i)"default"!==o&&function(n){e.d(t,n,function(){return i[n]})}(o);t["default"]=a.a},3021:function(n,t,e){},"36aa":function(n,t,e){"use strict";e.r(t);var i=e("7df3"),a=e("23ea");for(var o in a)"default"!==o&&function(n){e.d(t,n,function(){return a[n]})}(o);e("e64a");var s=e("2877"),r=Object(s["a"])(a["default"],i["a"],i["b"],!1,null,null,null);t["default"]=r.exports},"7df3":function(n,t,e){"use strict";var i=function(){var n=this,t=n.$createElement,e=(n._self._c,n.$t("index"));n.$mp.data=Object.assign({},{$root:{m0:e}})},a=[];e.d(t,"a",function(){return i}),e.d(t,"b",function(){return a})},e64a:function(n,t,e){"use strict";var i=e("3021"),a=e.n(i);a.a},f2f9:function(n,t,e){"use strict";(function(n){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var i=function(){return e.e("components/item/friendsList").then(e.bind(null,"7ee6"))},a=function(){return e.e("components/uni-icon/uni-icon").then(e.bind(null,"9fc1"))},o={components:{friendsList:i,uniIcon:a},data:function(){return{friendsList:[],isEnd:!1,index:0}},onShow:function(){"en-US"==n.getStorageSync("langType")?n.setNavigationBarTitle({title:"circleFriends"}):n.setNavigationBarTitle({title:"朋友圈"})},onLoad:function(){this.getFriendList(this.index)},onNavigationBarButtonTap:function(t){n.navigateTo({url:"/pages/releaseFriends/releaseFriends"})},onReachBottom:function(){var n=this;this.isEnd||(this.index++,setTimeout(function(){n.getFriendList(n.index)},300))},onPullDownRefresh:function(){this.index=0,this.getFriendList(this.index)},methods:{getFriendList:function(t){var e=this;this.ajax({url:"friend/list",data:{val:5,list:t},success:function(t){if(n.stopPullDownRefresh(),"success"===t.data.body){if(0===t.data.data.length)return e.isEnd=!0,void n.showToast({title:"没有更多数据了",icon:"none"});0!==e.index?e.friendsList=e.friendsList.concat(t.data.data):e.friendsList=t.data.data}}})}}};t.default=o}).call(this,e("6e42")["default"])}},[["698e","common/runtime","common/vendor"]]]);
});
